...
/******/ 	return __webpack_require__(__webpack_require__.s = "./stock-read.js");
/******/ })
/************************************************************************/
/******/ ({
...
var IncomingForm = __webpack_require__(/*! ./incoming_form */ "../node_modules/formidable/lib/incoming_form.js")
...
exports.handler = (event, context, callback) => {
  ...
  return client.query(q.Paginate(q.Match(q.Index("stock-by-sku"), data.sku))).then(response => {
